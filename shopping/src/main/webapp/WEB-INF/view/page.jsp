...
<html>
<head>
<title>Women's Fashion a Ecommerce Online Shopping Category Flat
...
<body>
	...
	<div class="header">
		<div class="container">
			...
			<div class="w3l_logo">
				<h1>
					<a href="index.html">Women's Fashion<span>For Fashion
							Lovers</span></a>
				</h1>
			</div>
			<div class="search">
			...
			<div class="cart box_1">
				<a href="checkout.html">
					<div class="total">
						...
						items)
					</div> <img src="${images}/bag.png" alt="" />
				</a>
				<p>
	...
	<div class="banner" id="home1">
		<div class="container">
			<h3>
				fashions fade, <span>style is eternal</span>
			</h3>
		</div>
	</div>
				...
				<div class="bs-example bs-example-tabs" role="tabpanel"
					...
					<ul id="myTab" class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="#home"
							id="home-tab" role="tab" data-toggle="tab" aria-controls="home">T-shirts</a></li>
						<li role="presentation"><a href="#skirts" role="tab"
							id="skirts-tab" data-toggle="tab" aria-controls="skirts">Skirts</a></li>
						<li role="presentation"><a href="#watches" role="tab"
							id="watches-tab" data-toggle="tab" aria-controls="watches">Watches</a></li>
						<li role="presentation"><a href="#sandals" role="tab"
							id="sandals-tab" data-toggle="tab" aria-controls="sandals">Sandals</a></li>
						<li role="presentation"><a href="#jewellery" role="tab"
							id="jewellery-tab" data-toggle="tab" aria-controls="jewellery">Jewellery</a></li>
					</ul>
		...
		<div class="container">
			...
			<div class="agileinfo_new_products_grids">
					...
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="${images}/27.jpg" alt=" " class="img-responsive" /> <img
								...
								src="${images}/27.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/28.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/29.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/30.jpg" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="${images}/31.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/32.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/33.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/34.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/31.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/32.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/33.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/34.jpg" alt=" " class="img-responsive" />
							<div class="w3_hs_bottom w3_hs_bottom_sub">
								<ul>
									<li><a href="#" data-toggle="modal"
					...
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="${images}/37.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/30.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/36.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/38.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/37.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/30.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/36.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/38.jpg" alt=" " class="img-responsive" />
							<div class="w3_hs_bottom w3_hs_bottom_sub">
								<ul>
									<li><a href="#" data-toggle="modal"
										data-target="#myModal6"><span
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="${images}/40.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/41.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/42.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/43.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/40.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/41.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/42.jpg" alt=" " class="img-responsive" /> <img
								src="${images}/43.jpg" alt=" " class="img-responsive" />
							<div class="w3_hs_bottom w3_hs_bottom_sub">
								<ul>
									<li><a href="#" data-toggle="modal"
